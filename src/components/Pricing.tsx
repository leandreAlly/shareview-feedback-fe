    ...
    <div className='bg-gray-800'>
      <div className='px-6 pt-12 lg:px-8 lg:pt-20'>
        <div className='text-center'>
          ...
          <p className='mt-2 text-3xl font-bold tracking-tight text-white sm:text-3xl lg:text-4xl'>
            ...
            <div className='relative lg:grid lg:grid-cols-7'>
                    ...
                    <div className='flex flex-1 flex-col justify-between border-t-2 border-gray-100 bg-gray-50 p-6 sm:p-10 lg:p-6 xl:p-10'>
                      ...
                      <div className='mt-8'>
                        <div className='rounded-lg shadow-md'>
                          <a
                            href='#'
                            className='block w-full rounded-lg border border-transparent bg-white px-6 py-3 text-center text-base font-medium text-[#64B937] hover:bg-gray-50'
              ...
              <div className='mx-auto mt-10 max-w-lg lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-4 lg:mx-0 lg:mt-0 lg:max-w-none'>
                <div className='relative z-10 rounded-lg shadow-xl'>
                  <div
                    className='pointer-events-none absolute inset-0 rounded-lg border-2 border-[#64B937]'
                    aria-hidden='true'
                  />
                  <div className='absolute inset-x-0 top-0 translate-y-px transform'>
                    <div className='flex -translate-y-1/2 transform justify-center'>
                      <span className='inline-flex rounded-full bg-[#64B937] px-4 py-1 text-base font-semibold text-white'>
                        Most popular
                      </span>
                    </div>
                  </div>
                  ...
                  <div className='rounded-b-lg border-t-2 border-gray-100 bg-gray-50 px-6 pt-10 pb-8 sm:px-10 sm:py-10'>
                    ...
                    <div className='mt-10'>
                      <div className='rounded-lg shadow-md'>
                        <a
                          href='#'
                          className='block w-full rounded-lg border border-transparent bg-[#64B937] px-6 py-4 text-center text-xl font-medium leading-6 text-white hover:bg-[#228B22]'
