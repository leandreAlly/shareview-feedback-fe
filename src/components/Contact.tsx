...
const Contact = () => {
  return (
    <>
      <section className='py-20 lg:py-[120px] overflow-hidden relative z-50'>
        <div className='container'>
          <div className='flex flex-wrap mx-[80px] lg:justify-between'>
              ...
              <div className='relative p-8 bg-white rounded-lg shadow-lg sm:p-12'>
                <form>
                  ...
                  <div>
                    <button
                      type='submit'
                      className='bg-[#64B937] w-full p-3 text-white transition border rounded border-primary bg-primary hover:bg-[#228B22]'
                    >
                      Send Message
                    </button>
                  </div>
